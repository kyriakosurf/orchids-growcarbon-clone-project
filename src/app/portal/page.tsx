...
const MaterialGraph = () => {
  return (
    <div className="relative h-[400px] w-full border border-white/5 rounded-2xl bg-[#050505] overflow-hidden group">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(217,119,6,0.05)_0%,transparent_70%)]" />
      ...
      <div className="p-8 flex flex-col h-full">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-bold tracking-[0.2em] uppercase text-amber-400/80">Active Bio-Conversion Flow</span>
          </div>
        ...
        <div className="flex-1 relative flex items-center justify-center">
          ...
          <motion.div
            ...
            transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
            className="absolute top-0 left-0 h-4 w-4 bg-amber-400 rounded-full blur-md"
          />
        </div>
...
const TECH_STACK = [
  ...
  },
  {
    ...
    bg: "from-blue-500/10 to-amber-500/10"
  },
  {
...
export default function PortalPage() {
  return (
    <div className="min-h-screen bg-[#020202] text-white selection:bg-amber-500/30 font-sans selection:text-amber-400">
      {/* UI Shell */}
        ...
        <div className="flex items-center gap-12">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[8px] font-bold text-amber-400 uppercase tracking-widest leading-none mt-1">Industrial Regeneration</span>
            </div>
          </div>
             ...
             <div className="flex flex-col items-end">
               ...
               <div className="flex items-center gap-2 mt-1">
                  <div className="h-1 w-12 bg-white/5 rounded-full overflow-hidden">
                    <motion.div animate={{ width: ["20%", "85%", "20%"] }} transition={{ duration: 10, repeat: Infinity }} className="h-full bg-amber-400" />
                  </div>
                  <span className="text-[10px] font-mono text-amber-400">NOMINAL</span>
               </div>
             </div>
          </div>
          <a href="mailto:info@growcarbon.eu">
            <Button className="h-10 rounded bg-white text-[10px] font-bold uppercase tracking-widest hover:bg-amber-400 text-black px-8 transition-all hover:shadow-[0_0_30px_rgba(217,119,6,0.3)]">
              Partner With Us
            </Button>
          </a>
        </div>
      ...
      <main className="pt-40 max-w-7xl mx-auto space-y-40 px-6 pb-40">
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-12">
              <div className="inline-flex items-center gap-3 px-5 py-2 rounded bg-amber-500/5 border border-amber-500/20">
                ...
                <span className="text-[9px] font-black uppercase tracking-[0.25em] text-amber-400">Status: Infrastructure Layer Active</span>
              </div>
           ...
           <div className="grid lg:grid-cols-2 gap-20 items-start">
              ...
              <div className="aspect-square bg-white/5 rounded-3xl border border-white/10 flex flex-col p-12 justify-center relative overflow-hidden group">
                 ...
                 <div className="space-y-8 relative z-10">
                    <div className="space-y-4">
                       <span className="text-[10px] font-black uppercase tracking-[0.3em] text-amber-400">• The Solution</span>
        ...
        <section className="space-y-20">
          <div className="text-center space-y-4">
            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-amber-400">The Bio-Conversion Engine</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TECH_STACK.map((card, i) => (
              <motion.div
                key={i}
                whileHover={{ y: -8 }}
                className="group relative overflow-hidden rounded-3xl border border-white/5 bg-[#080808] p-10 transition-all hover:border-amber-500/30"
              >
                ...
                <div className="relative z-10 space-y-8">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white/5 text-amber-400 group-hover:scale-110 group-hover:bg-amber-400 group-hover:text-black transition-all duration-500">
                    {card.icon}
                  </div>
                  <div className="space-y-4">
                    <div className="space-y-1">
                      <p className="text-[10px] font-black text-amber-400 uppercase tracking-widest">{card.category}</p>
           ...
           <div className="grid md:grid-cols-4 gap-10">
            {[
             ...
             <div key={i} className="space-y-8 group">
                <div className="h-16 w-16 rounded-2xl bg-white/5 flex items-center justify-center text-white/40 group-hover:bg-amber-400 group-hover:text-black transition-all">
                   {stake.icon}
                </div>
                <div className="space-y-4">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                   <span className="text-[10px] font-black text-amber-400 uppercase tracking-[0.2em]">{stake.benefit}</span>
                </div>
             </div>
          ))}
           </div>
      ...
      <footer className="border-t border-white/5 mt-40 py-32 px-8">
           ...
           <div className="col-span-1 lg:col-span-2 space-y-10">
              ...
              <div className="flex gap-6">
                 {['LinkedIn', 'X-Terminal', 'Reports', 'Status'].map(term => (
                   <a key={term} href="#" className="text-[10px] font-bold uppercase tracking-widest text-white/20 hover:text-amber-400 transition-colors">{term}</a>
                 ))}
              </div>
           </div>
        ...
        <div className="max-w-7xl mx-auto mt-32 pt-12 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-8">
           ...
           <div className="flex items-center gap-3">
              <div className="h-1.5 w-1.5 rounded-full bg-amber-400 shadow-[0_0_10px_rgba(217,119,6,0.5)]" />
              <span className="text-[9px] font-bold text-amber-400/40 uppercase tracking-[0.4em]">All Systems Nominal</span>
           </div>
        </div>
      </footer>
    </div>
